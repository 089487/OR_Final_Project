...
S14 & Load (Ultra-Low) & \textbf{10} & Normal & Roster-Ratio & (0, 30) \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\textbf{Tolerance} & $\delta=0$ (Baseline) & $4.79\% \pm 1.18\%$ & $\mathbf{1.92\% \pm 0.57\%}$ & $3.02\% \pm 1.34\%$ \\
 & $\delta=-10$ (Strict) & $4.65\% \pm 1.32\%$ & $\mathbf{1.90\% \pm 0.77\%}$ & $2.91\% \pm 1.71\%$ \\
 & $\delta=-5$ & $4.90\% \pm 1.24\%$ & $\mathbf{1.83\% \pm 0.82\%}$ & $3.24\% \pm 1.40\%$ \\
...
\toprule
Instance Level & Players & Teams & Picks/Team & DG Time(s) & OCG Time(s) & ILP Time(s) & ILP Status \\
\midrule
stress\_small  & 5,760 & 12 & 48 & 0.790 & 0.852 & 4.235 & OPTIMAL \\
stress\_medium & 9,600 & 15 & 64 & 0.951 & 1.144 & 12.230 & OPTIMAL \\
stress\_large  & 21,600 & 15 & 96 & 1.981 & 2.344 & 54.267 & OPTIMAL \\
stress\_xlarge & 64,000 & 20 & 160 & 6.172 & 10.360 & 276.895 & OPTIMAL \\
timeout\_target & 184,320 & 24 & 256 & 17.760 & 23.286 & \textbf{1869.805} & \textbf{TIMEOUT} \\
\bottomrule
\end{tabular}
}
\end{table}
...
After evaluating the algorithm across 14 distinct scenarios, we identify the conditions where the \textbf{Opportunity Cost Greedy (OCG)} algorithm provides the most significant strategic advantage. Table \ref{tab:highlights} highlights the top-performing scenarios based on the improvement over the baseline.
