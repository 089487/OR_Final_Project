...
\begin{itemize}
    ...
    \item \textbf{Market: Chaotic (S9):} Even when opponents' behavior is unpredictable, OCG maintains a robust lead, proving its delay-cost heuristic acts as a natural hedge against uncertain market conditions.
    \item \textbf{Demand: High (S11):} In environments where almost every player is drafted ($D=1$), DG often suffers from "positional blindness," leading to a 6.82\% loss in roster value. OCG's foresight prevents these late-draft collapses.
\end{itemize}
