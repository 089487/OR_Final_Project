...
| S2 | Value: Uniform | 3.24% ± 0.77% | 1.44% ± 0.59% |
| S3 | Value: Star-Heavy / High-Low | 8.39% ± 2.40% | 2.87% ± 1.32% |
| S4 | Pos: Random / Uniform-by-Type | 4.89% ± 0.62% | 1.07% ± 0.43% |
| S5 | Pos: Versatile / Value-Correlation | 5.36% ± 1.66% | 1.34% ± 0.68% |
| S6 | Pos: Rigid / Single-Position | 5.11% ± 1.48% | 0.94% ± 0.65% |
| S7 | Market: Rigid / $(0,0)$ | 1.47% ± 0.48% | 0.48% ± 0.23% |
...
| S14 | Load (Low, 3:1) | 4.79% ± 1.18% | 1.92% ± 0.57% |
| S15 | Load (Ultra-Low, 10:1) | 3.29% ± 0.85% | 1.16% ± 0.51% |
